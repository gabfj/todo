...
class TodoListsTest < ApplicationSystemTestCase
  ...
  test "creating a Todo list" do
    ...
    fill_in "Estado", with: @todo_list.estado
    fill_in "Inicio", with: @todo_list.inicio
    fill_in "Nombre", with: @todo_list.nombre
    fill_in "Responsable", with: @todo_list.responsable
    fill_in "Termino", with: @todo_list.termino
