...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { estado: @todo_list.estado, inicio: @todo_list.inicio, nombre: @todo_list.nombre, responsable: @todo_list.responsable, termino: @todo_list.termino } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { estado: @todo_list.estado, inicio: @todo_list.inicio, nombre: @todo_list.nombre, responsable: @todo_list.responsable, termino: @todo_list.termino } }
